<template>
    <div class="songDetail">
        ...
        <div class="bgFilter" :style="{backgroundImage: `url(${SongList ? SongList.coverImgUrl: ''})`}"></div>
       <div class="content">
            <div class="imgBox">
       ...
       <ul>
           ...
           <li v-for="(item,index) in song" @click="play(item.id)">
               <div class="songLeft">
                    {{index+1}}
                </div> 
                <div class="songRight">
...
export default {
    ...
    created() {
        ...
        this.axios.get(`http://192.168.1.28:3000/playlist/detail?id=${this.id}`).then(function(response){
            ...
            _this.playCount=Math.round((response.data.playlist.playCount/10000)*100/100);
